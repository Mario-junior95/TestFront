...
const Instructor = () => {
  ...
  useEffect(async () => {
    await Axios.get("https://pumpkin-shortcake-86885.herokuapp.com/api/instructor", {
      headers: {
  ...
  const deleteAdmin = async (id) => {
    try {
      await Axios.delete(`https://pumpkin-shortcake-86885.herokuapp.com/api/instructor/${id} `, {
        headers: {
